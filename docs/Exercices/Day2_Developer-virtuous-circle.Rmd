---
title: "Day 2: The developer virtuous circle"
output: 
...
- **Overarching goal:** Getting started with package development
- **Specific aims:** 
...
- Plot a plot of the aggregated `.bigwig` coverage over the `GRanges` of interest 
